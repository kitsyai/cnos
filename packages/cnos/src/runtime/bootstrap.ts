...
export const CNOS_SERVER_PROJECTION_PATH_ENV_VAR = 'CNOS_SERVER_PROJECTION_PATH';
export const CNOS_REQUIRE_SERVER_PROJECTION_ENV_VAR = 'CNOS_REQUIRE_SERVER_PROJECTION';
