...
export * from './manifest/normalizeVars.js';
...
export * from './runtime/readVar.js';
export * from './runtime/varStore.js';
export * from './runtime/varManager.js';
...
export * from './types/var.js';
export * from './types/workspace.js';
export * from './discovery/findCnosrc.js';
export * from './discovery/parseGitUri.js';
export * from './discovery/resolveRoot.js';
export * from './discovery/cache/cacheManager.js';
export * from './discovery/cache/cacheMetadata.js';
...
export * from './validation/validateVars.js';
export * from './validation/workspaceSafety.js';
export * from './spec/normalizeSpecRule.js';
